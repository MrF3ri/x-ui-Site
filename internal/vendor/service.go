...
func (s *Service) Create(ownerID int64, name, slug string) error { return s.repo.Create(ownerID,name,slug) }
func (s *Service) ListByOwner(ownerID int64) ([]models.Vendor, error) { return s.repo.ListByOwner(ownerID) }
